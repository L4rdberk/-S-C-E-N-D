...
local useFlowLink    = false
local hardcodedKeyLink = "https://aura-hub.mysellauth.com/product/ascend"
...
local function BuildKeyUI()
    ...
    acquireBtn.MouseButton1Click:Connect(function()
        local linkToCopy = useFlowLink and Arqel.Links.GetKey or hardcodedKeyLink
        if linkToCopy ~= "" then Arqel:Notify("Copied", "Key link copied!", 3, "copy") pcall(function() setclipboard(linkToCopy) end)
